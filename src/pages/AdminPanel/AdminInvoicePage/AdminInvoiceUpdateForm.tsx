...
const AdminInvoiceUpdateForm: React.FC = () => {
          ...
          <Form>
			...
			<div className="mb-3">
			  ...
			  <Field
				...
				name="totalPrice"
				id="totalPrice"
				value={invoiceData?.totalPrice || 0}
			...
			<div className="mb-3">
			  ...
			  />
			  <ErrorMessage name="discountRate" component="div" className="invalid-feedback" />
			</div>
			<div className="mb-3">
			  ...
			  />
			  <ErrorMessage name="taxRate" component="div" className="invalid-feedback" />
			</div>
            <div>
            <label htmlFor="rentalId" className="form-title mb-4">Rental Id {' '}</label>
            <Field as="select" name="rentalId">
              <option value="">Rental Id Seçiniz </option>
              {rentals.map(rental => (
...
export default AdminInvoiceUpdateForm;
