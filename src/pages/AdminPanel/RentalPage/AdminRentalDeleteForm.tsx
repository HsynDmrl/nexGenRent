...
import { deleteRental, setSelectedId } from '../../../store/rental/rentalSlice';
import { useAppDispatch } from '../../../store/configStore/useAppDispatch';
import { useAppSelector } from '../../../store/configStore/useAppSelector';

const AdminRentalDeleteForm: React.FC = () => {
      ...
      <Formik
		...
		onSubmit={(values, { setSubmitting, setStatus }) => {
			if (values.confirmationText === 'sil') {
			  try {
				dispatch(deleteRental(selectedRentalId as number));
        ...
        {({ isSubmitting, status }) => (
          <Form>
            ...
            {status && status.success && <Alert className='mb-2' variant="success">Araba başarıyla silindi.</Alert>}
...
export default AdminRentalDeleteForm;
